...
def main():
    ...
    # Uncomment the following lines if you wish to see the grid with 'O' marking the tiles on best paths
    ...
    # Mark and print the grid with 'O's
    marked_grid = mark_tiles_on_grid(grid, tiles_on_best_paths)
    print("\nWarehouse State with Best Path Tiles Marked (O):")
